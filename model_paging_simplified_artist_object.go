...
// checks if the PagingSimplifiedArtistObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagingSimplifiedArtistObject{}

// PagingSimplifiedArtistObject struct for PagingSimplifiedArtistObject
...
func NewPagingSimplifiedArtistObject(href string, limit int32, next NullableString, offset int32, previous NullableString, total int32, items []SimplifiedArtistObject) *PagingSimplifiedArtistObject {
	this := PagingSimplifiedArtistObject{}
	this.Href = href
	this.Limit = limit
	this.Next = next
	this.Offset = offset
...
func (o PagingSimplifiedArtistObject) MarshalJSON() ([]byte, error) {
...
func (o PagingSimplifiedArtistObject) ToMap() (map[string]interface{}, error) {
...
type NullablePagingSimplifiedArtistObject struct {
	value *PagingSimplifiedArtistObject
	isSet bool
}

func (v NullablePagingSimplifiedArtistObject) Get() *PagingSimplifiedArtistObject {
	return v.value
}

func (v *NullablePagingSimplifiedArtistObject) Set(val *PagingSimplifiedArtistObject) {
	v.value = val
	v.isSet = true
}

func (v NullablePagingSimplifiedArtistObject) IsSet() bool {
	return v.isSet
}

func (v *NullablePagingSimplifiedArtistObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagingSimplifiedArtistObject(val *PagingSimplifiedArtistObject) *NullablePagingSimplifiedArtistObject {
	return &NullablePagingSimplifiedArtistObject{value: val, isSet: true}
}

func (v NullablePagingSimplifiedArtistObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagingSimplifiedArtistObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
