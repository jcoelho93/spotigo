...
// checks if the EpisodeObjectAllOfShow type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EpisodeObjectAllOfShow{}

// EpisodeObjectAllOfShow The show on which the episode belongs. 
type EpisodeObjectAllOfShow struct {
...
func (o EpisodeObjectAllOfShow) MarshalJSON() ([]byte, error) {
...
func (o EpisodeObjectAllOfShow) ToMap() (map[string]interface{}, error) {
...
type NullableEpisodeObjectAllOfShow struct {
	value *EpisodeObjectAllOfShow
	isSet bool
}

func (v NullableEpisodeObjectAllOfShow) Get() *EpisodeObjectAllOfShow {
	return v.value
}

func (v *NullableEpisodeObjectAllOfShow) Set(val *EpisodeObjectAllOfShow) {
	v.value = val
	v.isSet = true
}

func (v NullableEpisodeObjectAllOfShow) IsSet() bool {
	return v.isSet
}

func (v *NullableEpisodeObjectAllOfShow) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEpisodeObjectAllOfShow(val *EpisodeObjectAllOfShow) *NullableEpisodeObjectAllOfShow {
	return &NullableEpisodeObjectAllOfShow{value: val, isSet: true}
}

func (v NullableEpisodeObjectAllOfShow) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEpisodeObjectAllOfShow) UnmarshalJSON(src []byte) error {
	v.isSet = true
