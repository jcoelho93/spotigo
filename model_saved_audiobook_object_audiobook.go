...
// checks if the SavedAudiobookObjectAudiobook type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SavedAudiobookObjectAudiobook{}

// SavedAudiobookObjectAudiobook Information about the audiobook.
type SavedAudiobookObjectAudiobook struct {
...
func NewSavedAudiobookObjectAudiobook(authors []AuthorObject, availableMarkets []string, copyrights []CopyrightObject, description string, htmlDescription string, explicit bool, externalUrls AudiobookBaseExternalUrls, href string, id string, images []ImageObject, languages []string, mediaType string, name string, narrators []NarratorObject, publisher string, type_ string, uri string, totalChapters int32, chapters AudiobookObjectAllOfChapters) *SavedAudiobookObjectAudiobook {
	this := SavedAudiobookObjectAudiobook{}
...
func (o SavedAudiobookObjectAudiobook) MarshalJSON() ([]byte, error) {
...
func (o SavedAudiobookObjectAudiobook) ToMap() (map[string]interface{}, error) {
...
type NullableSavedAudiobookObjectAudiobook struct {
	value *SavedAudiobookObjectAudiobook
	isSet bool
}

func (v NullableSavedAudiobookObjectAudiobook) Get() *SavedAudiobookObjectAudiobook {
	return v.value
}

func (v *NullableSavedAudiobookObjectAudiobook) Set(val *SavedAudiobookObjectAudiobook) {
	v.value = val
	v.isSet = true
}

func (v NullableSavedAudiobookObjectAudiobook) IsSet() bool {
	return v.isSet
}

func (v *NullableSavedAudiobookObjectAudiobook) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSavedAudiobookObjectAudiobook(val *SavedAudiobookObjectAudiobook) *NullableSavedAudiobookObjectAudiobook {
	return &NullableSavedAudiobookObjectAudiobook{value: val, isSet: true}
}

func (v NullableSavedAudiobookObjectAudiobook) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSavedAudiobookObjectAudiobook) UnmarshalJSON(src []byte) error {
	v.isSet = true
