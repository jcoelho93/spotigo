...
func (r ApiGetUsersSavedAudiobooksRequest) Execute() (*PagingSavedAudiobookObject, *http.Response, error) {
...
func (a *LibraryApiService) GetUsersSavedAudiobooksExecute(r ApiGetUsersSavedAudiobooksRequest) (*PagingSavedAudiobookObject, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGetUsersTopArtistsRequest struct {
	ctx context.Context
	ApiService *LibraryApiService
	timeRange *string
	limit *int32
...
func (r ApiGetUsersTopArtistsRequest) TimeRange(timeRange string) ApiGetUsersTopArtistsRequest {
	r.timeRange = &timeRange
	return r
}

func (r ApiGetUsersTopArtistsRequest) Limit(limit int32) ApiGetUsersTopArtistsRequest {
	r.limit = &limit
	return r
}

func (r ApiGetUsersTopArtistsRequest) Offset(offset int32) ApiGetUsersTopArtistsRequest {
	r.offset = &offset
	return r
}

func (r ApiGetUsersTopArtistsRequest) Execute() (*PagingArtistObject, *http.Response, error) {
...
Get the current user's top artists based on calculated affinity.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetUsersTopArtistsRequest
*/
func (a *LibraryApiService) GetUsersTopArtists(ctx context.Context) ApiGetUsersTopArtistsRequest {
	return ApiGetUsersTopArtistsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *LibraryApiService) GetUsersTopArtistsExecute(r ApiGetUsersTopArtistsRequest) (*PagingArtistObject, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGetUsersTopTracksRequest struct {
	ctx context.Context
	ApiService *LibraryApiService
	timeRange *string
	limit *int32
...
func (r ApiGetUsersTopTracksRequest) TimeRange(timeRange string) ApiGetUsersTopTracksRequest {
	r.timeRange = &timeRange
	return r
}

func (r ApiGetUsersTopTracksRequest) Limit(limit int32) ApiGetUsersTopTracksRequest {
	r.limit = &limit
	return r
}

func (r ApiGetUsersTopTracksRequest) Offset(offset int32) ApiGetUsersTopTracksRequest {
	r.offset = &offset
	return r
}

func (r ApiGetUsersTopTracksRequest) Execute() (*PagingTrackObject, *http.Response, error) {
...
Get the current user's top tracks based on calculated affinity.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetUsersTopTracksRequest
*/
func (a *LibraryApiService) GetUsersTopTracks(ctx context.Context) ApiGetUsersTopTracksRequest {
	return ApiGetUsersTopTracksRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *LibraryApiService) GetUsersTopTracksExecute(r ApiGetUsersTopTracksRequest) (*PagingTrackObject, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiRemoveShowsUserRequest) SaveShowsUserRequest(saveShowsUserRequest SaveShowsUserRequest) ApiRemoveShowsUserRequest {
...
func (r ApiSaveShowsUserRequest) SaveShowsUserRequest(saveShowsUserRequest SaveShowsUserRequest) ApiSaveShowsUserRequest {
	r.saveShowsUserRequest = &saveShowsUserRequest
	return r
}
