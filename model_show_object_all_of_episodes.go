...
// checks if the ShowObjectAllOfEpisodes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShowObjectAllOfEpisodes{}

// ShowObjectAllOfEpisodes The episodes of the show. 
type ShowObjectAllOfEpisodes struct {
...
func (o ShowObjectAllOfEpisodes) MarshalJSON() ([]byte, error) {
...
func (o ShowObjectAllOfEpisodes) ToMap() (map[string]interface{}, error) {
...
type NullableShowObjectAllOfEpisodes struct {
	value *ShowObjectAllOfEpisodes
	isSet bool
}

func (v NullableShowObjectAllOfEpisodes) Get() *ShowObjectAllOfEpisodes {
	return v.value
}

func (v *NullableShowObjectAllOfEpisodes) Set(val *ShowObjectAllOfEpisodes) {
	v.value = val
	v.isSet = true
}

func (v NullableShowObjectAllOfEpisodes) IsSet() bool {
	return v.isSet
}

func (v *NullableShowObjectAllOfEpisodes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShowObjectAllOfEpisodes(val *ShowObjectAllOfEpisodes) *NullableShowObjectAllOfEpisodes {
	return &NullableShowObjectAllOfEpisodes{value: val, isSet: true}
}

func (v NullableShowObjectAllOfEpisodes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShowObjectAllOfEpisodes) UnmarshalJSON(src []byte) error {
	v.isSet = true
