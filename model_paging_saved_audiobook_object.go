...
// checks if the PagingSavedAudiobookObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagingSavedAudiobookObject{}

// PagingSavedAudiobookObject struct for PagingSavedAudiobookObject
...
func NewPagingSavedAudiobookObject(href string, limit int32, next NullableString, offset int32, previous NullableString, total int32, items []SavedAudiobookObject) *PagingSavedAudiobookObject {
	this := PagingSavedAudiobookObject{}
	this.Href = href
	this.Limit = limit
	this.Next = next
	this.Offset = offset
...
func (o PagingSavedAudiobookObject) MarshalJSON() ([]byte, error) {
...
func (o PagingSavedAudiobookObject) ToMap() (map[string]interface{}, error) {
...
type NullablePagingSavedAudiobookObject struct {
	value *PagingSavedAudiobookObject
	isSet bool
}

func (v NullablePagingSavedAudiobookObject) Get() *PagingSavedAudiobookObject {
	return v.value
}

func (v *NullablePagingSavedAudiobookObject) Set(val *PagingSavedAudiobookObject) {
	v.value = val
	v.isSet = true
}

func (v NullablePagingSavedAudiobookObject) IsSet() bool {
	return v.isSet
}

func (v *NullablePagingSavedAudiobookObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagingSavedAudiobookObject(val *PagingSavedAudiobookObject) *NullablePagingSavedAudiobookObject {
	return &NullablePagingSavedAudiobookObject{value: val, isSet: true}
}

func (v NullablePagingSavedAudiobookObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagingSavedAudiobookObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
