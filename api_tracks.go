...
*/
func (a *TracksApiService) GetUsersTopTracks(ctx context.Context) ApiGetUsersTopTracksRequest {
	return ApiGetUsersTopTracksRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *TracksApiService) GetUsersTopTracksExecute(r ApiGetUsersTopTracksRequest) (*PagingTrackObject, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
