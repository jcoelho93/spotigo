...
// checks if the AudiobookObjectAllOfChapters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AudiobookObjectAllOfChapters{}

// AudiobookObjectAllOfChapters The chapters of the audiobook. 
type AudiobookObjectAllOfChapters struct {
...
func NewAudiobookObjectAllOfChapters(href string, limit int32, next NullableString, offset int32, previous NullableString, total int32, items []SimplifiedChapterObject) *AudiobookObjectAllOfChapters {
	this := AudiobookObjectAllOfChapters{}
	this.Href = href
	this.Limit = limit
	this.Next = next
	this.Offset = offset
...
func (o AudiobookObjectAllOfChapters) MarshalJSON() ([]byte, error) {
...
func (o AudiobookObjectAllOfChapters) ToMap() (map[string]interface{}, error) {
...
type NullableAudiobookObjectAllOfChapters struct {
	value *AudiobookObjectAllOfChapters
	isSet bool
}

func (v NullableAudiobookObjectAllOfChapters) Get() *AudiobookObjectAllOfChapters {
	return v.value
}

func (v *NullableAudiobookObjectAllOfChapters) Set(val *AudiobookObjectAllOfChapters) {
	v.value = val
	v.isSet = true
}

func (v NullableAudiobookObjectAllOfChapters) IsSet() bool {
	return v.isSet
}

func (v *NullableAudiobookObjectAllOfChapters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAudiobookObjectAllOfChapters(val *AudiobookObjectAllOfChapters) *NullableAudiobookObjectAllOfChapters {
	return &NullableAudiobookObjectAllOfChapters{value: val, isSet: true}
}

func (v NullableAudiobookObjectAllOfChapters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAudiobookObjectAllOfChapters) UnmarshalJSON(src []byte) error {
	v.isSet = true
