...
func (r ApiGetAUsersAvailableDevicesRequest) Execute() (*DevicesObject, *http.Response, error) {
...
func (a *PlayerApiService) GetAUsersAvailableDevicesExecute(r ApiGetAUsersAvailableDevicesRequest) (*DevicesObject, *http.Response, error) {
	var (
...
func (r ApiGetTheUsersCurrentlyPlayingTrackRequest) Execute() (*CurrentlyPlayingObject, *http.Response, error) {
...
func (a *PlayerApiService) GetTheUsersCurrentlyPlayingTrackExecute(r ApiGetTheUsersCurrentlyPlayingTrackRequest) (*CurrentlyPlayingObject, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
