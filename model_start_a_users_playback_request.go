...
// SetContextUri gets a reference to the given string and assigns it to the ContextUri field.
...
// SetPositionMs gets a reference to the given int32 and assigns it to the PositionMs field.
